...
void hal_disablefiq_savecpuflg();
void hal_enablefiq_restcpuflg();
void hal_disableirq_savecpuflg();
void hal_enableirq_restcpuflg();
void hal_disableirqfiq_savecpuflg();
void hal_enableirqfiq_restcpuflg();
