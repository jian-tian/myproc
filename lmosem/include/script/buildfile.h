...
#define BUILD_KRNL_OBJS krlinit.o krlpagempol.o krlglobal.o krlmm.o krlintupt.o krlobjnode.o krldevice.o krlsem.o krltime.o krlsched.o krlthread.o krlcpuidle.o krlwaitlist.o task.o
